...
config.General.requestName = 'LLGDV_Analysis_ZJetsNuNuHT600-Inf_noLeptonTrigger' 
...
config.Data.publishDataName = 'LLGDV_Analysis_AnalysisNTuple_ZJetsNuNuHT600-Inf_Spring15_v03'
